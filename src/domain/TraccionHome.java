...
public class TraccionHome {
	...
	public void attachDirty(Traccion instance) {
		log.debug("attaching dirty Traccion instance");
		try {
	...
	public void attachClean(Traccion instance) {
		log.debug("attaching clean Traccion instance");
		try {
	...
	public void delete(Traccion persistentInstance) {
		log.debug("deleting Traccion instance");
		try {
	...
	public Traccion merge(Traccion detachedInstance) {
		...
		try {
			Traccion result = (Traccion) sessionFactory.getCurrentSession()
	...
	public Traccion findById(short id) {
		...
		try {
			Traccion instance = (Traccion) sessionFactory.getCurrentSession()
					.get("Traccion", id);
			if (instance == null) {
	...
	public List findByExample(Traccion instance) {
		log.debug("finding Traccion instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Traccion").add(Example.create(instance))
					.list();
