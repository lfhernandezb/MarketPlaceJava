...
public class ModeloHome {
	...
	public Modelo merge(Modelo detachedInstance) {
		...
		try {
			Modelo result = (Modelo) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Modelo findById(int id) {
		...
		try {
			Modelo instance = (Modelo) sessionFactory.getCurrentSession().get(
					"Modelo", id);
			if (instance == null) {
	...
	public List findByExample(Modelo instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Modelo").add(Example.create(instance))
					.list();
