...
public class MarcaHome {
	...
	public Marca merge(Marca detachedInstance) {
		...
		try {
			Marca result = (Marca) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Marca findById(int id) {
		...
		try {
			Marca instance = (Marca) sessionFactory.getCurrentSession().get(
					"Marca", id);
			if (instance == null) {
	...
	public List findByExample(Marca instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Marca").add(Example.create(instance))
					.list();
