...
public class TipoTransmisionHome {
	...
	public void attachDirty(TipoTransmision instance) {
		log.debug("attaching dirty TipoTransmision instance");
		try {
	...
	public void attachClean(TipoTransmision instance) {
		log.debug("attaching clean TipoTransmision instance");
		try {
	...
	public void delete(TipoTransmision persistentInstance) {
		log.debug("deleting TipoTransmision instance");
		try {
	...
	public TipoTransmision merge(TipoTransmision detachedInstance) {
		...
		try {
			TipoTransmision result = (TipoTransmision) sessionFactory
	...
	public TipoTransmision findById(short id) {
		...
		try {
			TipoTransmision instance = (TipoTransmision) sessionFactory
					.getCurrentSession().get("TipoTransmision", id);
			if (instance == null) {
	...
	public List findByExample(TipoTransmision instance) {
		log.debug("finding TipoTransmision instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("TipoTransmision")
