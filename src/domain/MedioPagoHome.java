...
public class MedioPagoHome {
	...
	public void attachDirty(MedioPago instance) {
		log.debug("attaching dirty MedioPago instance");
		try {
	...
	public void attachClean(MedioPago instance) {
		log.debug("attaching clean MedioPago instance");
		try {
	...
	public void delete(MedioPago persistentInstance) {
		log.debug("deleting MedioPago instance");
		try {
	...
	public MedioPago merge(MedioPago detachedInstance) {
		...
		try {
			MedioPago result = (MedioPago) sessionFactory.getCurrentSession()
	...
	public MedioPago findById(short id) {
		...
		try {
			MedioPago instance = (MedioPago) sessionFactory.getCurrentSession()
					.get("MedioPago", id);
			if (instance == null) {
	...
	public List findByExample(MedioPago instance) {
		log.debug("finding MedioPago instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("MedioPago").add(Example.create(instance))
					.list();
