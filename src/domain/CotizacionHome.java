...
public class CotizacionHome {
	...
	public void attachDirty(Cotizacion instance) {
		log.debug("attaching dirty Cotizacion instance");
		try {
	...
	public List findByExample(Cotizacion instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Cotizacion").add(Example.create(instance))
					.list();
