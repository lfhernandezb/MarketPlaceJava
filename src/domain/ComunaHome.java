...
public class ComunaHome {
	...
	public Comuna merge(Comuna detachedInstance) {
		...
		try {
			Comuna result = (Comuna) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Comuna findById(int id) {
		...
		try {
			Comuna instance = (Comuna) sessionFactory.getCurrentSession().get(
					"Comuna", id);
			if (instance == null) {
	...
	public List findByExample(Comuna instance) {
		log.debug("finding Comuna instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Comuna").add(Example.create(instance))
					.list();
