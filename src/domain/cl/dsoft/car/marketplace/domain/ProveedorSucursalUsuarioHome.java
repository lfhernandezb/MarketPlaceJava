...
public class ProveedorSucursalUsuarioHome {
	...
	public void remove(ProveedorSucursalUsuario persistentInstance) {
	...
	public ProveedorSucursalUsuario merge(
		...
		try {
			ProveedorSucursalUsuario result = entityManager
	...
	public ProveedorSucursalUsuario findById(Integer id) {
		...
		try {
			ProveedorSucursalUsuario instance = entityManager.find(
